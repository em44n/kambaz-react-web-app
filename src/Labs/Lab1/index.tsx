...
This is the third paragraph. Wrap each paragraph with the paragraph tag to tell browsers to render the gaps.
  ...
  <li>Combine flour, baking soda, and salt in a bowl.</li>
    <li>Cream butter, sugars, eggs, and vanilla in another bowl.</li>
    <li>Stir the dry ingredients into the wet mixture, then fold in chocolate chips.</li>
    <li>Place dough balls on a baking sheet and bake at 350°F for 10-12 minutes.</li>
    <li>Let cookies cool slightly and enjoy!</li>
  </ol>
